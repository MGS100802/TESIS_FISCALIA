...
class IngestionAgent:
    ...
    def extract_process_police_report(self, path_pdf: str, path_txt="data/resumenes_casos/"):
        ...
        con trazabilidad del caso y retorna los nodos raíz, tamaño del grupo, resumen y metadatos.
        """
        ...
        try:
            ...
            - "Resumen_caso": Breve resumen forense de los hechos y tipología de delito investigado.
            ...
            - "Metadatos_utiles": Otra información clave para la investigación (armas incautadas, vehículos, modus operandi, comunas o ubicaciones involucradas, tipos de delitos conexos como receptación).
            ...
            return ruts_involucrados, tamano_grupo, resumen_caso, metadatos_utiles  
